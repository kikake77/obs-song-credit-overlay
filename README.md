...
3. `SongCreditManagerForOBS_v0.4.0_Windows.zip` をダウンロードします。
...
2. **デザイン**から次のどれかを選びます。
   ...
   - 文字のみ（背景パネルなし）
3. **フォント**を選びます。
4. **クレジット表記**を日本語・英語・コンパクトから選びます。
5. タブ上部のプレビューで確認します。

変更は自動保存され、同じURLを登録したOBSへすぐ反映されます。OBSのURLを変更する必要はありません。
